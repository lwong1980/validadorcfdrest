...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros">
	...
	<!-- 
		En esta secciÃ³n se define la inclusiÃ³n de las demÃ¡s plantillas de transformaciÃ³n para 
		la generaciÃ³n de las cadenas originales de los complementos fiscales 
	-->
	...
	<xsl:template match="cfdi:Concepto">
		...
		<!--
			Manejo de los distintos sub nodos de informaciÃ³n aduanera de forma indistinta 
	...
	<!-- Manejador de nodos tipo InformaciÃ³n Aduanera -->
	<xsl:template match="cfdi:InformacionAduanera">
		<!-- Manejo de los atributos de la informaciÃ³n aduanera -->
		<xsl:call-template name="Requerido">
	...
	<!-- Manejador de nodos tipo InformaciÃ³n CuentaPredial -->
